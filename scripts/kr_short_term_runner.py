"""Run the Korean short-term strategy on shared analysis logs."""
...
from autostocktrading.config.kr_strategy_watchlists import get_short_term_entries  # noqa: E402
from autostocktrading.strategies import evaluate_short_term_candidate  # noqa: E402
from autostocktrading.services.strategy_signal_runner import run_signal_batch  # noqa: E402


STATE_PATH = ROOT_DIR / "logs" / "state" / "kr_short_term_runner.json"


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the Korean short-term signal runner.")
...
def main() -> int:
    ...
    while True:
        code = run_signal_batch(
            ...
            entries=get_short_term_entries(),
