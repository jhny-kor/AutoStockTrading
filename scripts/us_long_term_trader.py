"""Run the US long-term order engine using KIS overseas trading."""
...
STATE_PATH = ROOT_DIR / "logs" / "state" / "us_long_term_trader.json"


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the US long-term order engine.")
