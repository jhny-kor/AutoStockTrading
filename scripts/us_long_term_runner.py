"""Run the US long-term strategy on shared overseas analysis logs."""
...
from autostocktrading.strategies.us_long_term import evaluate_us_long_term_candidate  # noqa: E402
from autostocktrading.services.us_strategy_signal_runner import run_us_signal_batch  # noqa: E402


STATE_PATH = ROOT_DIR / "logs" / "state" / "us_long_term_runner.json"


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the US long-term signal runner.")
